...
if(isset($_POST['ID'], $_POST['borrowOrLend'], $_POST['paymentInterval'], $_POST['STARTDATE'], $_POST['PAYMENTNUM'], $_POST['VALUE'], $_POST['RATE'])){
  ...
  if($borrowOrLend == "Lend"){
    ...
    $sql = "INSERT INTO 
loan(loanAmount,interestRate,loanStatus,notificationStatus,loanDateStart,loanDateEnd,paymentSchedule,numberPayments,dateSent,timeSent,debtorSignature, 
creditorSignature, groupLoanID) VALUES ($amount,$rate,'pending','Sent','$date','$endDate','$paymentInterval',$paymentnum,CURDATE(),CURRENT_TIME(),NULL, '$name', 
NULL);";
    ...
    $sql = "INSERT INTO 
loan(loanAmount,interestRate,loanStatus,notificationStatus,loanDateStart,loanDateEnd,paymentSchedule,numberPayments,dateSent,timeSent,debtorSignature, 
creditorSignature, groupLoanID) VALUES ($amount,$rate,'pending','Sent','$date','$endDate','$paymentInterval',$paymentnum,CURDATE(),CURRENT_TIME(),'$name',NULL, 
NULL);";
    if(mysqli_query($conn, $sql)){
