...
public class OpenLoanListObject {
    ...
    public OpenLoanListObject(String borrowerLender, String openLoanID, String amount, String interestRate, String paymentType, String startDate, String numPayments){
