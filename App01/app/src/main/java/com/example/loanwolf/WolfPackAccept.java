...
public class WolfPackAccept extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_wolf_pack_accept);
        ...
        TextView lenderBorrowerTxtView = findViewById(R.id.TextView2);
        TextView amountTxtView = findViewById(R.id.TextView3);
        TextView interestTxtView = findViewById(R.id.TextView4);
        TextView startDateTxtView = findViewById(R.id.TextView5);
        TextView numPaymentsTxtView = findViewById(R.id.TextView6);
        TextView timeIntervalTxtView = findViewById(R.id.TextView7);

        // Set the results into TextViews
        lenderBorrowerTxtView.setText(borrowerLender);
        amountTxtView.setText(amount);
        interestTxtView.setText(String.valueOf(Float.valueOf(interestRate)));
        startDateTxtView.setText(startDate);
        numPaymentsTxtView.setText(numPayments);
        timeIntervalTxtView.setText(paymentType);
    }

    public void ClickViewOpenLoans(View view) {
        Intent intent = new Intent(WolfPackAccept.this, ViewWolfPacks.class);
        ...
        alertDialogBuilder.setPositiveButton("yes",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        Toast.makeText(WolfPackAccept.this, "Loan Accepted", Toast.LENGTH_LONG).show();
                        ...
                        VolleySingleton.getInstance(WolfPackAccept.this).addToRequestQueue(stringRequest);
                    }
                });
